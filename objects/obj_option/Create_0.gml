...
var _olt_harder = add_option_toggle(game_menu, 7, "option_olt_harder_bosses", function(_val)
{
...
var _olt_elite = add_option_toggle(game_menu, 8, "option_olt_elite_enemies", function(_val)
{
